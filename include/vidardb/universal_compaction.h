...
#ifndef STORAGE_VIDARDB_UNIVERSAL_COMPACTION_OPTIONS_H
...
class CompactionOptionsUniversal {
 public:
  ...
  // a size amplification of 0%. VidarDB uses the following heuristic
...
#endif  // STORAGE_VIDARDB_UNIVERSAL_COMPACTION_OPTIONS_H
